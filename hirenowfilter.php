                        ...
                        <form method="post" >
                            <div class="row">
                                <input list="catagory" id="catagox" name="catagory" type="text" placeholder="Select Service Catagory" required>
                                    ...
                                    <input list="City" id="citox" name="City" type="text" placeholder=" Select City" required>
                                    <datalist id="City">
...
$row = mysqli_query($con, "Select Emp_GIG_ID from gigs where GIG_City='$city' AND GIG_skill='$catagory'");
...
<?php   
    ...
    while($query=mysqli_fetch_array($row)){
        $sug_id= $query['Emp_GIG_ID'];
        $ret1=mysqli_query($con, "Select employees.*,gigs.*,users.* From employees 
        INNER JOIN gigs ON employees.Emp_User_ID=gigs.Emp_GIG_ID
    INNER JOIN users ON gigs.Emp_GIG_ID=users.User_ID where employees.Emp_User_ID='$sug_id'");
