            ...
            <div class="wrapper">
                <div class="according">
                    <div class="item">
                        ...
                        <label for="one" class="title">How much your service cost?</label>
                        <div class="content">It depends to customer requirements.</div>
                    </div>
                    <div class="item">
                    ...
                    <div class="item">
                        ...
                        <label for="three" class="title">How will payments be accepted??</label>
                        <div class="content">Hand cash, mobile banking or I banking.</div>
                    </div>
                    <div class="item">
                        <input type="radio" id="four" name="item">
                        <label for="four" class="title">How does the reporting work??</label>
                        <div class="content">So basically reporting is for the the people who gets assaulted by our employee such as verbally,physically etc.</div>
                    </div>
                    <div class="item">
